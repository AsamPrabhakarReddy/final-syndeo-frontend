...
const Hero = () => {
  return (
    <div role="hero" className="w-full bg-white pt-28 pb-8 h-auto ">
      <div className="max-w-[1400px] m-auto grid md:grid-cols-2 ">
        <div className="flex flex-col gap-4 w-full">
          <div role="hero1"className=" flex items-center lg:justify-start justify-center mt-4 mx-3">
          ...
          <div role="hero2" className="flex items-center lg:justify-start justify-center mx-3">
          ...
          <div role="hero3" className="flex items-center lg:justify-start justify-center mx-3">
          ...
          <div role="button" className="flex items-center lg:justify-start justify-center md:mx-5">
            <a
              href="/login"
        ...
        <div role="heroLottie" className="flex justify-center lg:justify-end items-center ">
          <Lottie
            loop={ true}
            autoplay = {true}
